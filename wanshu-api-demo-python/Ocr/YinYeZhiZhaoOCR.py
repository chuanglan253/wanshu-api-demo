...
if __name__ == "__main__":
	...
	#要识别的图片
	imageFile=open(r'c:\image.jpg','rb')	
	base64Str=base64.b64encode(imageFile.read())
	imageFile.close()
	
	invoke_data = {'appId': '12345678', 'appKey': '12345678', 'imageType': 'BASE64','image': base64Str}
	invoke_url = 'https://api.253.com/open/i/ocr/business-license'
