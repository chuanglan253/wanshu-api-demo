...
if __name__ == "__main__":
    invoke_url = 'https://api.253.com/open/bankcard/card-two-auth'
    invoke_data = {'appId': '12345678', 'appKey': '12345678', 'name': '李*','cardNo': '621233211111****'}
    ...
    if result is None or '200000' != result['code'] or 'data' not in result:
        ...
        print u'调用银行卡四要素认证成功,data:', result['data']
