...
if __name__ == "__main__":
    invoke_url = 'https://api.253.com/open/bankcard/card-three-auth-detail'
    invoke_data = {'appId': '12345678', 'appKey': '12345678', 'name': '李*', 'idNum':'43122319890725****', 'cardNo': '621233211111****'}
    ...
    if result is None or '200000' != result['code'] or 'data' not in result:
        ...
        # 解析结果数据，进行业务处理
        # 检测结果
        print u'调用银行卡三要素详细版认证成功,data:', result['data']
