...
if __name__ == "__main__":
    invoke_url = 'https://api.253.com/open/company/factor-verify'
    invoke_data = {'appId': '12345678', 'appKey': '12345678', 'companyName': 'ABC', 'frName': '张三', 'socialCreditCode': '91110108551385****'}
