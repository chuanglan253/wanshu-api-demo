...
if __name__ == "__main__":
	...
	imageFile2=open(r'c:\image2.jpg','rb') #身份证照片
	
	base64Str2=base64.b64encode(imageFile2.read()) #读取文件内容，转换为base64编码
	
	imageFile2.close()

    	invoke_url = 'https://api.253.com/open/i/witness/witness-check-final'
	
    	invoke_data = {'appId': '12345678', 'appKey': '12345678', 'imageType': 'BASE64','liveImage': base64Str,'idCardImage': base64Str2}
