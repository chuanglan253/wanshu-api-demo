 ...
 * 营业执照ocr接口样例
 */
public class YinYeZhiZhaoOCRApi {

    private static String APP_ID = "qqqqqqqq";

    private static String APP_KEY = "qqqqqqqq";

    private static String API_URL = "https://api.253.com/open/i/ocr/business-license";
    ...
    private static JsonObject invokeChangeRecord() {
        ...
        params.put("image", "http://***.***.***/download/pic/idcard-demo.jpg");
