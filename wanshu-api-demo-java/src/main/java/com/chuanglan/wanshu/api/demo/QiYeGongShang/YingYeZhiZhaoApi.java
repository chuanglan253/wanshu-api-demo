...
public class YingYeZhiZhaoApi {
    ...
    private static String API_URL = "https://api.253.com/open/company/business-license";
    ...
    public static void main(String[] args) {
        ...
        if (jsonObject != null) {
            ...
            if ("200000".equals(code) && jsonObject.get("data") != null) {
                ...
                System.out.println("企业营业执行查询成功,content is :" + content);
            } else {
                // 记录错误日志，正式项目中请换成log打印
                System.out.println("企业营业执行查询失败,code:" + code + ",msg:" + jsonObject.get("message").getAsString());
            }
        }
    }
