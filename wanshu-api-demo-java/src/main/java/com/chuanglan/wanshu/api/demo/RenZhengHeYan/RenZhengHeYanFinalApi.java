 ...
 * 人证核验精准版接口样例
 */
public class RenZhengHeYanFinalApi {
    private static String APP_ID = "qqqqqqqq";

    private static String APP_KEY = "qqqqqqqq";

    private static String API_URL = "https://api.253.com/open/i/witness/witness-check-final";
    ...
    private static JsonObject invokeChangeRecord() {
        ...
        params.put("liveImage", "http://***.***.***/download/pic/live-demo.jpg");
        params.put("idCardImage", "http://***.***.***/download/pic/idcard-demo.jpg");
