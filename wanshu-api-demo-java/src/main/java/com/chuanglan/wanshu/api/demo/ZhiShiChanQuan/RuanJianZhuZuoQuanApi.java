package com.chuanglan.wanshu.api.demo.ZhiShiChanQuan;
 ...
 * 软件著作权
 */
public class RuanJianZhuZuoQuanApi {

    private static String APP_ID = "qqqqqqqq";

    private static String APP_KEY = "qqqqqqqq";

    private static String API_URL = "https://api.253.com/open/ipr/software-copyright";
