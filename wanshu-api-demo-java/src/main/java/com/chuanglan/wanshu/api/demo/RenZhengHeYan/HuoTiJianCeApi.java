...
import com.chuanglan.wanshu.api.demo.KonghaoApi;
 ...
 * 活体检测
 */
public class HuoTiJianCeApi {

    private static String APP_ID = "qqqqqqqq";

    private static String APP_KEY = "qqqqqqqq";

    private static String API_URL = "https://api.253.com/open/i/witness/face-check";
    ...
    private static JsonObject invokeChangeRecord() {
        ...
        params.put("image", "http://***.***.***/download/pic/live-demo.jpg");
