 ...
 * 银行卡三要素标准版
 */
public class YinhangkaSanYaoSuApi {

    private static String APP_ID_YINHANGKA = "12345678";

    private static String APP_KEY_YINHANGKA = "12345678";

    private static String API_URL_YINHANGKA = "https://api.253.com/open/bankcard/card-three-auth";

    private static JsonParser jsonParser = new JsonParser();

    public static void main(String[] args) {
        // 1.调用接口api
        final JsonObject jsonObject = invokeYinhangka("李*", "43122319890725****",
                "622600021110****");
