package com.chuanglan.wanshu.api.demo.YunYingSanYaoSu;
 ...
 * 运营商三要素详细版认证
 */
public class YunYingShangSanYaoSuApi {

    private static String APP_ID_SHENFEN = "qqqqqqqq";

    private static String APP_KEY_SHENFEN = "qqqqqqqq";

    private static String API_URL_SHENFEN = "https://api.253.com/open/carriers/carriers-auth-detail";
    ...
    private static JsonObject invokeShenfen() {
        ...
        params.put("name", "李*");
        params.put("idNum", "11010120710101****");
