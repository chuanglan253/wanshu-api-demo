 ...
 * 十大流通股东接口样例
 */
public class ShiDaLiuTongGuDongApi {

	private static String APP_ID = "qqqqqqqq";

    private static String APP_KEY = "qqqqqqqq";

    private static String API_URL = "https://api.253.com/open/stock/ten-tradableholders";
	...
	private static JsonObject invokeFactorVerify() {
		...
		params.put("year", "2018");//年度
		params.put("quarter", "1");//季度
