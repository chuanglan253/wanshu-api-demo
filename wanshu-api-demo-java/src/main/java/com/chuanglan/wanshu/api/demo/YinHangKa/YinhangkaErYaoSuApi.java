 ...
 * 银行卡二要素
 */
public class YinhangkaErYaoSuApi {

    private static String APP_ID_YINHANGKA = "12345678";

    private static String APP_KEY_YINHANGKA = "12345678";

    private static String API_URL_YINHANGKA = "https://api.253.com/open/bankcard/card-two-auth";

    private static JsonParser jsonParser = new JsonParser();

    public static void main(String[] args) {
        // 1.调用接口api
        final JsonObject jsonObject = invokeYinhangka("李*","622600021110****");
    ...
    private static JsonObject invokeYinhangka(String name,String cardNo) {
